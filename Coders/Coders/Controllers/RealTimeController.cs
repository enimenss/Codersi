    ...
    public class RealTimeController : Controller
    {
        ...
        public JsonResult Register(User landmarkModel)
        {
           int count = (from u in db.Users where u.Username == landmarkModel.Username || u.Email == landmarkModel.Email select u).Count();
            ...
            User user = new User { Id=7,Email = landmarkModel.Email, Username = landmarkModel.Username, Pass = landmarkModel.Pass, Named = landmarkModel.Named, Surname = landmarkModel.Surname, Guid = Guid.NewGuid(), Picture =landmarkModel.Picture };

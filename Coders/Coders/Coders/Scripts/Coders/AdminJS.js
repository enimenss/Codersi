...
function DetailsUser(data) {
    ...
    $("<div class='form-group' id='DivImage'></div>").appendTo(modalBody);
    $('#DivImage').append("<img style='margin:auto; width:100px; height:100px;' src='../Images/" + data.FilePath + "'>");
...
function DetailsCompetition(data) {
    ...
    $("<div class='form-group' id='DivName'></div>").appendTo(modalBody);
    $('#DivName').append("<label class='col-md-5'>Name: </label>");
    $('#DivName').append("<div class='input-group'><span class='input-group-addon'><i class='glyphicon glyphicon-home'></i></span><input class='col-md-6 form-control' type='text' id='Name' disabled /><br />");
    $('#Name').val(data.Name);
    ...
    $('#DivNoLand').append("<label class='col-md-5'>Landmarks: </label>");
    $('#DivNoLand').append("<div class='input-group'><span class='input-group-addon'><i class='glyphicon glyphicon-tasks'></i></span><input class='col-md-6 form-control' type='text' id='LandmarkCount' disabled /><br />");
    $('#LandmarkCount').val(data.LandmarkCount);
...
function DetailsLandmark(data) {
    ...
    $('#DivHintsL').append("<button type='button' value = " + data.Id + " onclick='AddHint(this)' class='btn btn-default'><span class='glyphicon glyphicon-plus'></span> Add hint</button><br />");
    $('#DivHintsL').append("<button onclick='CloseDetailsLandmark()' class='btn btn-default'><span class='glyphicon glyphicon-delete'></span> Close</button>");
}

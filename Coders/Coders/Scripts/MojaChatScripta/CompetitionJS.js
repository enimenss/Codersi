...
function NextHint() {
    ...
    $('#DivDescription').append("<input style='background-color:#e8d2a2' class='col-md-5 form-control' type='text' id='Description'/><br />");
    ...
    $('#DivAnswer').append("<input class='col-md-5 form-control' style='background-color:#e8d2a2' type='text' id='Answer'/><br />");
    $('#Answer').val(null);

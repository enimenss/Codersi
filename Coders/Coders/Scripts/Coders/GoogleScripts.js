...
changeCity = function (newCity) {
    $.ajax({
        url: ServerAddres + "Admin/getNewCityPosition",//add Controler Name,
        type: "POST",
        dataType: 'json',
        cache: false,
...
GetAllLandmarks = function (city) {
    $.ajax({
        url: ServerAddres + "Admin/MakeAGraph",//add Controler Name,
        type: "POST",
        dataType: 'json',
        cache: false,
        data: { "city": city },
...
sendGraphToServerForValidation = function (SaveToDatabase, City, CompatitionId) {
    $.ajax({
        url: ServerAddres + "Admin/GetGraph",//add Controler Name,
        type: "POST",
        dataType: 'json',
        data: {
...
getpathsForGraph = function (numBersOfTeamMates, fromDatabase, City, CompatitionId) {
    $.ajax({
        url: ServerAddres + "Admin/GetRouts",//add Controler Name,
        type: "POST",
        dataType: 'json',
        data: {

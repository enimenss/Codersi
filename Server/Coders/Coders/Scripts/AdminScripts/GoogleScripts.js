...
sendGraphToServerForValidation = function ()
{
    $.ajax({
...
getpathsForGraph = function (numBersOfTeamMates)
{
    $.ajax({
        url: ServerAddres + "RealTime/addRouts",//add Controler Name,
        type: "POST",
        dataType: 'json',
        data: { "graph": Graph },
        cache: false,
